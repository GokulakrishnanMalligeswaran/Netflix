    ...
    <div className=" w-full  ">
      ...
      <div className="relative ">
        ...
        <div className="absolute w-full p-8 bottom-4">
          <img src={hero_title} alt="" className=" w-[90%] max-w-[420px] mb-7 md:w-80" />
          <p className="w-[700px] text-[17px] mb-7 md:text-[12px]">
          ...
          <div className="flex space-x-3 mb-12 md:mb-1">
